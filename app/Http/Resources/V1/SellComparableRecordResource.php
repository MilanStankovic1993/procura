...
/** @mixin SellComparableRecord */
class SellComparableRecordResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'assessment_input_hash' => $this->assessment_input_hash,
            ...
            'source_reliability_basis_points' => (
                $this->source_reliability_basis_points
            ),
            ...
            'market_normalizations' => (
                SellComparableMarketNormalizationResource::collection(
                    $this->whenLoaded('marketNormalizations'),
                )
            ),
