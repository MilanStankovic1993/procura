...
class StoreComparableRequest extends FormRequest
{
    protected function prepareForValidation(): void
    {
        $this->merge([
            ...
            'included_accessories' => $this->input('included_accessories', []),
            'missing_accessories' => $this->input('missing_accessories', []),
        ]);
    }
    ...
    public function rules(): array
    {
        return [
            ...
            'listing_type' => ['required', Rule::enum(ComparableListingType::class)],
            'condition_code' => ['required', Rule::enum(ComparableCondition::class)],
            'seller_type' => ['required', Rule::enum(ComparableSellerType::class)],
            'asking_price_minor' => [
                'required',
                'integer',
                'min:1',
