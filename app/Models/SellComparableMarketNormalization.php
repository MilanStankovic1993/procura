...
final class SellComparableMarketNormalization extends Model
{
    ...
    protected static function booted(): void
    {
        self::updating(static function (): never {
            throw new LogicException(
                'Sell comparable market-normalization evidence is immutable.',
            );
        });
        self::deleting(static function (): never {
            throw new LogicException(
                'Sell comparable market-normalization evidence cannot be deleted individually.',
            );
        });
    }
