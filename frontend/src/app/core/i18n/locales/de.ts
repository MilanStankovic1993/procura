...
export const DE_TRANSLATIONS = {
  ...
  'guidedIntake.step': 'Schritt {{current}} von {{total}}',
  'guidedIntake.progress': 'Formularfortschritt',
  'guidedIntake.back': 'Zurück',
  'guidedIntake.next': 'Weiter',
  'guidedIntake.review': 'Übersicht',
  'guidedIntake.optionalDetails': 'Optionale Angaben',
  ...
  'dashboard.actionEyebrow': 'Ihre nächste Entscheidung',
  'dashboard.actionTitle': 'Was möchten Sie tun, {{name}}?',
  'dashboard.actionLead':
    'Wählen Sie einen Weg. Procura führt Sie durch die Angaben und ordnet die Marktnachweise.',
  'dashboard.activeWorkspace': 'Aktiver Arbeitsbereich',
  'dashboard.chooseAction': 'Procura-Ablauf auswählen',
  'dashboard.buyLabel': 'Ich möchte kaufen',
  'dashboard.buyTitle': 'Prüfen Sie, ob sich ein Angebot lohnt.',
  'dashboard.buyDescription':
    'Teilen Sie Angebot und Zielmarkt. Wir ordnen Preis, Kosten, Produktzuordnung und Risiken vor Ihrer Entscheidung.',
  'dashboard.buyBenefitPrice': 'Fairer Preis',
  'dashboard.buyBenefitRisk': 'Risikoprüfung',
  'dashboard.buyBenefitDecision': 'Klare Empfehlung',
  'dashboard.buyAction': 'Angebot prüfen',
  'dashboard.sellLabel': 'Ich möchte verkaufen',
  'dashboard.sellTitle': 'Finden Sie den richtigen Preis für Ihr Produkt.',
  'dashboard.sellDescription':
    'Beschreiben Sie Ihr Produkt und den Zielmarkt. Wir bereiten Nachweise, Preisspanne und Angebotsleitfaden vor.',
  'dashboard.sellBenefitPrice': 'Preisspanne',
  'dashboard.sellBenefitSpeed': 'Verkaufsdauer',
  'dashboard.sellBenefitListing': 'Angebotsleitfaden',
  'dashboard.sellAction': 'Produkt bewerten',
  'dashboard.permissionRequired': 'Arbeitsbereichsleitung um Start bitten',
  'dashboard.recentEyebrow': 'Arbeit fortsetzen',
  'dashboard.recentTitle': 'Machen Sie dort weiter, wo Sie aufgehört haben.',
  'dashboard.recentDescription':
    'Ihre letzten Prüfungen bleiben hier, damit Sie nicht in Menüs suchen müssen.',
  'dashboard.loadingRecent': 'Letzte Arbeiten werden geladen...',
  'dashboard.recentError': 'Ihre letzten Arbeiten konnten nicht geladen werden.',
  'dashboard.emptyTitle': 'Noch keine Prüfungen.',
  'dashboard.emptyDescription': 'Wählen Sie oben Kaufen oder Verkaufen für die erste geführte Prüfung.',
  'dashboard.recentBuy': 'Geprüfte Angebote',
  'dashboard.recentSell': 'Produkte im Verkauf',
  'dashboard.viewAll': 'Alle anzeigen',
  'dashboard.noRecentBuy': 'Noch keine Kaufprüfung in diesem Arbeitsbereich.',
  'dashboard.noRecentSell': 'Noch keine Verkaufsprüfung in diesem Arbeitsbereich.',
  'dashboard.categoryPending': 'Kategorie nicht ausgewählt',
  ...
  'listingIntake.guidedEyebrow': 'Geführte Kaufprüfung',
  'listingIntake.guidedDescription': 'Drei kurze Schritte. Geben Sie jetzt an, was Sie wissen; den Rest können Sie später ergänzen.',
  'listingIntake.stepSource': 'Das Angebot',
  'listingIntake.stepMarket': 'Der Markt',
  'listingIntake.stepEvidence': 'Fotos & Prüfung',
  'listingIntake.sourceQuestion': 'Welches Angebot sollen wir prüfen?',
  'listingIntake.sourceHelp': 'Fügen Sie den Angebotslink und einen erkennbaren Titel ein. Procura behält die Quelle bei.',
  'listingIntake.sourceUrlPrompt': 'Angebotslink',
  'listingIntake.sourceUrlHint': 'Optional. Wenn möglich, erkennen wir den Marktplatz über den Link.',
  'listingIntake.sourceDetails': 'Quelldetails ändern',
  'listingIntake.sourceContinent': 'Herkunftskontinent',
  'listingIntake.targetContinent': 'Zielkontinent',
  'listingIntake.marketQuestion': 'Wo befindet sich der Artikel und wo sollen wir vergleichen?',
  'listingIntake.marketHelp': 'Wählen Sie zuerst die Kontinente, damit nur relevante Länder erscheinen.',
  'listingIntake.evidenceQuestion': 'Fügen Sie alles hinzu, was die Prüfung erleichtert',
  'listingIntake.evidenceHelp': 'Fotos und Screenshots sind jetzt optional und können später ergänzt werden.',
  'listingIntake.reviewSource': 'Quelle',
  'listingIntake.reviewRoute': 'Marktweg',
  'listingIntake.reviewFiles': 'Dateien',
  ...
  'ownedProduct.intake.guidedEyebrow': 'Geführter Verkauf',
  'ownedProduct.intake.guidedDescription': 'Beschreiben Sie Ihren Artikel in drei kurzen Schritten. Unbekannte Angaben können leer bleiben.',
  'ownedProduct.intake.stepProduct': 'Produkt',
  'ownedProduct.intake.stepCondition': 'Zustand',
  'ownedProduct.intake.stepGoal': 'Verkaufsziel',
  'ownedProduct.intake.productHelp': 'Beginnen Sie mit einem Namen oder Foto. Die Identifizierung kann später verfeinert werden.',
  'ownedProduct.intake.conditionQuestion': 'In welchem Zustand ist der Artikel?',
  'ownedProduct.intake.conditionHelp': 'Wählen Sie die passendste Antwort. Weitere Angaben sind optional.',
  'ownedProduct.intake.conditionDetails': 'Zubehör oder Mängel ergänzen',
  'ownedProduct.intake.goalQuestion': 'Wo und wie möchten Sie verkaufen?',
  'ownedProduct.intake.goalHelp': 'Wählen Sie einen Kontinent und danach die Länder, die Procura berücksichtigen soll.',
  'ownedProduct.intake.countrySearch': 'Länder suchen',
  'ownedProduct.intake.showAllCountries': 'Alle Länder anzeigen',
